...
switch (week_days) {
  ...
  case 6:
    ...
    break;
  default:
    message2 = "Unknown - " + week_days;
    break;
}

/* OUTPUT */

// Step 1: Assign the value of the first message variable to the HTML element with an ID of message
message1 = document.querySelector("#message1").textContent;

// Step 2: Assign the value of the second message variable to the HTML element with an ID of message2
message2 = document.querySelector("#message2").textContent;
